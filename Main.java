...
class Main extends JFrame implements ActionListener{
    ...
    * */
    ...
    public void DisplayContactinfo(){
        ...
        String About = 
  	"	\tHiLCoE\n"+
  	"\tA.P Shah Institute of Techno;ogy\n\n\n"+
  	"Welcome to JAVA-IMAGE Encryption program \n\n"+
	"CS224 : Java Mini Project \n"+
	"\tStudent Name1 : Pal Prince (20102147) \n" +            
    "\tStudent Name1 : Chandan Yadav (20102082) \n" +
    "\tStudent Name1 : Kartik Shukla  (20102181) \n" +
